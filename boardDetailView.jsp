                    ...
                    <tr>
                       <c:choose>
                         <c:when test="${ empty loginUser }">
		                        <th colspan="2">
		                            <textarea class="form-control" id="content" cols="55" rows="2" style="resize:none; width:100%;" readonly>로그인한 사용자만 이용가능한 서비스입니다. 로그인 후 이용 바랍니다.</textarea>
		                        </th>
      ...
      function addReply(){
    	  ...
    	  if($("#content").val().trim().length != 0) {
    		 // 입력한 내용물 기준으로 공백 제거 후에도 문자열의 길이가 0이 아니라면 =>유효한 내용물이 있다고 간주 
    		  ...
    		  alertify.alert("댓글작성 실패", "댓글 작성후 등록 요청해주세요.");
    	  }
